...
if (!function_exists('get_ip_info')) {
    ...
    {
        $access_key = 'dee25316b9d11e2ee34d6a443b423510';
...
if (!function_exists('get_client_ip')) {
    ...
    {
        $ch = curl_init('https://ipinfo.io/json?token=9641bd4a19ec80');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        $json = curl_exec($ch);
        curl_close($ch);
        $api_result = json_decode($json, true);
        ...
        return [
            'ip' => $api_result['ip'],
            'city' => $api_result['city'],
            'country_name' => code_to_country($api_result['country']),
        ];
    }
}
...
if (!function_exists('get_device')) {
    ...
    function get_device()
    {
        ...
        if ($tablet_browser > 0) {
            ...
            return trans('hwa_helpers::hwa_common.label.tablet');
        } else if ($mobile_browser > 0) {
            // do something for mobile devices
            return trans('hwa_helpers::hwa_common.label.mobile');
        } else {
            // do something for everything else
            return trans('hwa_helpers::hwa_common.label.computer');
        }
    }
}
